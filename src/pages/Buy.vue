  ...
  <q-page padding>
    <div class="row justify-center">
      <div class="col-grow col-lg-6 col-md-7 col-sm-8">
        <q-form @submit="onContinue" @reset="onReset" class="q-gutter-sm">
          <div
            class="text-h5 bg-primary text-secondary q-my-md q-pa-md rounded-borders"
          >
            Purchase Innouts Cards
          </div>
                      ...
                      <tr>
                        <td>
                          <q-badge
                            ...
                            align="middle"
                            class="float-rigt"
                            title="these cards are valid until the end of the active transfer window, i.e. current window (if inside a window) or next."
                          >
                      ...
                      <tr>
                        <td>
                          <q-badge
                            ...
                            align="top"
                            class=""
                            title="these cards are timeless, i.e. you will have them forever!"
                          >
                            <q-icon name="info" color="white" />
                          </q-badge>
                          Permanent Card
        ...
        <div
          v-show="payForm"
          ref="card"
          class="q-my-lg bg-secondary q-pa-lg rounded-borders bordered"
        >
          <div id="card-element">
...
export default {
  ...
  computed: {
    ...
    total: function () {
      return (
        this.tempIn * 1 + this.tempOut * 2 + this.permIn * 7 + this.permOut * 10
      )
    }
  },
      ...
      if (this.total > 0) {
        ...
        this.$axios({
          ...
          data: {
            ...
            tempIn: parseInt(this.tempIn),
            tempOut: parseInt(this.tempOut),
            permIn: parseInt(this.permIn),
            permOut: parseInt(this.permOut),
          ...
          if (result.error) {
            ...
            if (result.paymentIntent.status === "succeeded") {
              ...
              this.$q.notify({
                ...
                message:
                  "Purchase complete. An invoice is sent to your email, thanks."
              });
