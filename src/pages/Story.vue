  ...
  <q-page padding>
    <div class="row justify- q-gutter-y-m">
      <div class="col offset- bordered rounded-borders q-pa-xs" :class="storyClass">
        ...
        />
        <div id="body" v-html="story.body" class="text-body1 newsBody2 text-justify text-center q-my-md q-py-sm q-px-xs"/>
        <div v-html="story.extended" class="text-body2 newsBody2 text-justify text-center q-my-md q-py-sm q-px-xs"/>
