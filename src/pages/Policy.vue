  ...
  <q-page padding>
    <div class="row justify-center">
      <div class="col-grow col-lg-6 col-md-7 col-sm-8 text-body text-justify">
        <div class="text-h4 text-center q-my-lg q-py-sm bg-primary text-secondary">Privacy Policy</div>
            <p>Effective date: September 28, 2018</p>

            <p>Innouts ("us", "we", or "our") operates the http://www.innouts.com website (the "Service").</p>
            ...
            <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use
               ...
               in this Privacy Policy have the same meanings as in our Terms of Service, accessible <router-link to="/terms">here.</router-link></p>

            <h5 class="q-my-md">Information Collection And Use</h5>

            <p>We collect several different types of information for various purposes to provide and improve our Service to
               you.</p>

            <h5 class="q-my-md">Types of Data Collected</h5>

            <h6 class="q-my-md">Personal Data</h6>
            ...
            <h6 class="q-my-md">Usage Data</h6>

            <p>We may also collect information about how the Service is accessed and used ("Usage Data"). This Usage Data may include
            ...
            <h6 class="q-my-md">Tracking & Cookies Data</h6>
            ...
            <h5 class="q-my-md">Use of Data</h5>

            <p>Innouts uses the collected data for various purposes:</p>
            <ul>
            ...
            <h5 class="q-my-md">Transfer Of Data</h5>
            ...
            <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement
               to that transfer.</p>
            <p>Innouts will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
            ...
            <h5 class="q-my-md">Disclosure Of Data</h5>

            <h6 class="q-my-md">Legal Requirements</h6>
            <p>Innouts may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
               <li>To comply with a legal obligation</li>
               <li>To protect and defend the rights or property of Innouts</li>
               <li>To prevent or investigate possible wrongdoing in connection with the Service</li>
               <li>To protect the personal safety of users of the Service or the public</li>
               <li>To protect against legal liability</li>
            </ul>

            <h6 class="q-my-md">Security Of Data</h6>
            ...
            <h6 class="q-my-md">Service Providers</h6>
            ...
            <h5 class="q-my-md">Links To Other Sites</h5>
            ...
            <h5 class="q-my-md">Children's Privacy</h5>
            ...
            <h5 class="q-my-md">Changes To This Privacy Policy</h5>
...
export default {
  ...
  meta () {
    return {
      title: 'Policy | Innouts',

      meta: {
        description: { name: 'description', content: 'Innouts privacy policy' },
        keywords: { name: 'keywords', content: ['Innouts', 'privacy policy'] },
      },
    }
  },
}
